import type { ConfidenceDistribution, SetMetrics } from "../types.js";
...
/**
 * Score required/forbidden sets.
 * TP = required found; FN = required missing; FP = forbidden found.
 */
...
export function confidenceDistribution(values: readonly number[]): ConfidenceDistribution {
  if (values.length === 0) {
