...
9. **Adapter research: Continue / Cline / other niche tools** — inventory official project config paths; open an issue with sources; do not implement until reviewed. (Copilot, Windsurf, Gemini CLI, and Aider shipped — see [surfaces-and-adapters.md](../reference/surfaces-and-adapters.md).)
10. **Rule documentation gaps** — audit `docs/reference/rules.md` against `src/core/rules/registry.ts` and file missing sections as docs PRs.
