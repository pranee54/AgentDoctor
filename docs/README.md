...
| [project-brain.md](project-brain.md)                                   | Project Brain (evidence-backed understanding) |
| [mcp/brain-mcp.md](mcp/brain-mcp.md)                                   | Project Brain MCP (agent consumption layer)   |
| [demo/brain-mcp-demo.md](demo/brain-mcp-demo.md)                       | Killer demo: Brain → MCP → Agent              |
| [../validation/mcp-agent/README.md](../validation/mcp-agent/README.md) | Real-agent MCP validation report              |
...
| [release-notes-v1.1.0.md](release-notes-v1.1.0.md)           | v1.1.0 release notes (Brain → MCP → Agent) |
